...
class PropertiesConfigurationParserTests {
    ...
    fun parse_simple() {
        ...
        assertEquals(configuration.projectId, projectId)
    }
    ...
    fun parse_simple_parent_child() {
        ...
        assertEquals(parent.projectId, projectId)
        ...
        assertEquals(child.projectId, projectId)
    ...
    fun parse_dependency_loop() {
        ...
        val exception = assertThrows(IllegalStateException::class.java) {
            parser.parse(projectId, rawConfigurations)
        }
